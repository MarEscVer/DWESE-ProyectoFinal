...
public class AsignaturaController {
	 ...
	 * 
	 * @return ResponseEntity con la lista de asignaturas y el código de estado HTTP
	 *         correspondiente.
	 */
	@GetMapping("/")
	 ...
	 * @return ResponseEntity con la asignatura y el código de estado HTTP
	 *         correspondiente.
	 */
	@GetMapping("/{id}")
	public ResponseEntity<?> getAsignaturaById(@PathVariable("id") Long id) {
		try {
			...
			return new ResponseEntity<>("No se encontró asignatura con el ID", HttpStatus.NOT_FOUND);
		}
	}
	 ...
	 * @return ResponseEntity con la asignatura creada y el código de estado HTTP
	 *         correspondiente.
	 */
	@PostMapping("/")
	 ...
	 * @return ResponseEntity con la asignatura actualizada y el código de estado
	 *         HTTP correspondiente.
	 */
	@PutMapping("/{id}")
	public ResponseEntity<Asignatura> updateAsignatura(@PathVariable("id") Long id,
